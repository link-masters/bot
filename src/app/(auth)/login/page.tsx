    ...
    <Card className="w-full border-border/50 bg-card/50 backdrop-blur-sm">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          ...
          <Button type="submit" className="w-full py-6 text-base glow cursor-pointer" disabled={isLoading}>
            {isLoading ? (
              <>
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full py-5 border-border/40 hover:bg-accent/40 flex items-center justify-center gap-2 cursor-pointer text-sm font-medium"
